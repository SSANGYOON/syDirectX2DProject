...
namespace SY {
	...
	public:
		...
		void InvokeOnCollisionStay(Collision* collision);
	...
	public:
		...
		static void OnCollisionStay(Entity entity, Collision* collision);
		static void OnCollisionExit(Entity entity, Collision* collision);
