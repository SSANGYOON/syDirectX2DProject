    ...
    public class Inventory : Entity
    {
        ...
        void OnUpdate(float ts)
        {
            ...
            if(Input.IsKeyDown(KeyCode.Z)) {
                ...
                {
                    var weaponData = items.itemDatas[(int)CurrentCategory][currentPanelIndex] as WeaponData;
                    ...
                    if (items.itemDatas[(int)CurrentCategory].Count > 0)
                    {
                        ...
                        else if (weaponData != null)
                        {
                            ...
                            Console.WriteLine(weaponData.spritePath);
            ...
            if(CurrentCategory == InventoryData.CATEGORY.Weapon)
            {
                ...
                for (int i = 0; i < weapon.Count; i++)
                {
                    ...
                    if (weapon[i] as WeaponData == player.zWeapon.Data || weapon[i] as WeaponData == player.xWeapon.Data)
